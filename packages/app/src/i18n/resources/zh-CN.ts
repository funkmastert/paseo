...
export const zhCN: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 workspace 不是作为 Bozeo worktree 创建的",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 Bozeo 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 Bozeo 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 Bozeo 无法停止 daemon。",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 Bozeo 的 Intel 构建。",
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocs: "中继如何工作",
      relayDocsAccessibility: "阅读 Bozeo 中继的工作原理",
      enableRelay: "启用中继",
      enablingRelay: "正在启用...",
      notNow: "暂不",
      directConnectionHint:
        "不使用中继时，请通过 TCP、Tailscale 或其他 VPN 直接连接。不会生成二维码。",
      updateRequired: "请更新主机，以便从 Bozeo Desktop 启用中继。",
      unavailable: "配对 offer 不可用。",
      hint: "用手机上的 Bozeo 扫描此二维码，或复制下方链接。",
  ...
  panels: {
    ...
    orchestration: {
      ...
      emptyState: "此主机上还没有 Agent",
      labelAll: "编排：全部 Agent",
      subtitleAll: "全部 Agent",
      subtitleLeader: "当前树",
      scopeLeader: "当前树",
      scopeAll: "全部",
      scopeMissing: "该树已不存在。切换到“全部”查看其余内容。",
      emptyStateFiltered: "没有活动中的 Agent。已隐藏 {{count}} 个较早的 Agent。",
      showOlder: "显示 {{count}} 个较早的",
      hideOlder: "隐藏较早的",
      usageUnavailable: "用量不可用",
      usageAsOf: "{{time}}的用量",
      accountRoleLeader: "负责人",
      accountRolePrimary: "主要工作账号",
      accountRoleBackup: "备用",
      accountUsage: "负责人 {{leaders}} · 工作者 {{workers}}",
      accountIdle: "未使用",
      accountsInUse: "使用中：{{accounts}}",
      accountsNoneInUse: "没有运行中的智能体",
      staleTitle: "未在更新",
  ...
  mcpStatus: {
    ...
    failure: {
      ...
      unknownAgent: "报告此问题的代理已不再打开。请打开一个使用它的代理。",
      providerHasNoConfig: "Paseo 无法读取 {{provider}} 的 MCP 配置，因此无法代理它。",
      accountSignedOut: "{{provider}} 未登录。请在主机上执行以下命令，然后重试：",
      serverNotInConfig:
        "{{name}} 不在 Paseo 为 {{provider}} 读取的 MCP 配置中。代理从别处加载它，Paseo 无法得知来源。",
      serverIsLocal: "{{name}} 以本地命令运行。只有 http 和 sse 服务器可以被代理。",
      adoptFailed: "无法代理 {{name}}：{{error}}",
      unknownServer: "网关没有代理名为 {{name}} 的服务器。",
      staticAuth: "{{name}} 使用已保存的请求头登录，没有需要授权的内容。",
      ...
      unknown: "无法代理 {{name}}：{{error}}",
    },
    remedy: {
      redirectUrl: "需要注册的重定向 URI",
      path: "主机上的文件",
      snippet: "添加",
      command: "在主机上执行",
    },
    showFullError: "查看完整消息",
    showLessError: "收起消息",
    copyError: "复制消息",
    copiedError: "已复制",
    reportedBy: "由 {{agent}} 报告",
    reportedByOn: "{{provider}} 上的 {{agent}}",
    reportedByCount: "由 {{count}} 个代理报告",
    reportedOn: "在 {{provider}} 上",
    expand: "展开 MCP 状态",
    collapse: "收起 MCP 状态",
  },
  contextWindow: {
    ...
    breakdownLoading: "正在读取上下文…",
    breakdownPending: "本轮结束后会显示明细。",
    breakdownUnsupported: "该提供方无法报告上下文明细。",
    breakdownError: "无法读取上下文明细。",
    breakdownAsOf: "截至 {{time}}",
    breakdownBarAccessibility: "上下文窗口明细",
    deferredTitle: "窗口之外",
    messageToolResults: "工具结果",
    messageAttachments: "附件",
    messageAssistant: "助手",
    messageToolCalls: "工具调用",
    messageUser: "用户消息",
  ...
  settings: {
    ...
    notifications: {
      ...
      sending: "正在发送...",
      sentTitle: "测试通知已发送",
      sentDescription: "Bozeo 已将通知交给操作系统。",
    ...
    metadataGeneration: {
      title: "元数据生成",
      description: "选择 Bozeo 用于工作区标题、分支名称、提交消息和拉取请求草稿的模型",
      selection: "模型选择",
      automatic: "自动",
      preferred: "手动",
      automaticHint: "Bozeo 会选择一个可用的快速模型",
      preferredHint: "选择 Bozeo 使用的模型",
      model: "模型",
      fallbackHint: "如果不可用，Bozeo 会改用其他可用模型",
      docs: "文档",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "浏览器标签页在 Bozeo 中共享登录状态和网站数据。",
        clear: "清除浏览器数据",
        clearing: "正在清除...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "这会更新此电脑上的 Bozeo",
        installConfirm: "安装更新",
        update: "更新",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "更新 Bozeo skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 Bozeo skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 Bozeo 编排 skills。",
        choose: "选择 skills",
        chooseAll: "全部 skills",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。Bozeo 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage: "发送重启请求失败。Bozeo 会自动重连，请在 Host 显示在线后重试。",
          dialogFailedMessage: "无法打开重启确认对话框。",
        },
        update: {
          desktopManagedHint: "此 Daemon 由 Bozeo Desktop 管理。请在 Host 上更新 Bozeo Desktop。",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "Bozeo 会监管该进程，并通过 $PASEO_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 Bozeo 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
